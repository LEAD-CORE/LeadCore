...
(() => {
  ...
  const UI = {
    ...
    renderAll(){
      const appName = State.data.settings.appName || "LeadCore";
      document.title = appName;
      // update sidebar brand text (if present)
      if(this.els.brandTitle) this.els.brandTitle.textContent = appName;
      if(this.els.brandSub) this.els.brandSub.textContent = "CRM • כחול‑לבן Enterprise";
