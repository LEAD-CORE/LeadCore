...
(() => {
  ...
  const UI = {
    ...
    unlockScrollIfNone(){
      const anyOpen = (this.els.modalCustomer && this.els.modalCustomer.classList.contains('is-open')) || (this.els.drawerCustomer && this.els.drawerCustomer.classList.contains('is-open'));
      if (!anyOpen) this.unlockScroll();
    },

    closeModal() {
      this.els.modalCustomer.classList.remove("is-open");
      this.els.modalCustomer.setAttribute("aria-hidden", "true");
      this.unlockScrollIfNone();
    },
    ...
    lockScroll(){ document.body.classList.add('noScroll'); },

    unlockScroll(){ document.body.classList.remove('noScroll'); },
