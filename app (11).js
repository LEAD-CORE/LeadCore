...
// ---------------------------
// Global Loading Overlay (silent, no toasts)
// ---------------------------
function ensureGlobalLoading_(){
  ...
  el.innerHTML = `
    ...
    <div class="globalLoading__panel" role="status" aria-live="polite">
      <div class="globalLoading__spinner" aria-hidden="true"></div>
      <div>
        <div class="globalLoading__text" id="globalLoadingText">טוען…</div>
        <div class="globalLoading__sub">שנייה אחת וממשיכים</div>
      </div>
    </div>`;
